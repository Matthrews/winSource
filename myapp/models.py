...
class Product(models.Model):
    ...
    Availability = models.CharField(verbose_name="产品总数量", default=None, blank=True,
                                    db_column='item_availablity_text', max_length=32)  # item_availablity_text
    LowestPrice = models.CharField(verbose_name="最低价格", max_length=32, default=None, blank=True,
